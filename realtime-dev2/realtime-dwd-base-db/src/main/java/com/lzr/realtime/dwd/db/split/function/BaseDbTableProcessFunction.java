package com.lzr.realtime.dwd.db.split.function;

import com.alibaba.fastjson.JSONObject;
import com.lzr.realtime.bean.TableProcessDwd;
...
/**
 * @Package com.lzr.realtime.dwd.db.split.function.BaseDbTableProcessFunction
 * @Author lv.zirao
...
public class BaseDbTableProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDwd, Tuple2<JSONObject,TableProcessDwd>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDwd> tableProcessDwdList
                = JdbcUtil.querList(mySQLConnection, "select * from gmall2024_config.table_process_dwd", TableProcessDwd.class, true);
    ...
    @Override
    public void processElement(com.alibaba.fastjson.JSONObject jsonObj, BroadcastProcessFunction<com.alibaba.fastjson.JSONObject, TableProcessDwd, org.apache.flink.api.java.tuple.Tuple2<com.alibaba.fastjson.JSONObject, TableProcessDwd>>.ReadOnlyContext ctx, Collector<org.apache.flink.api.java.tuple.Tuple2<com.alibaba.fastjson.JSONObject, TableProcessDwd>> out) throws Exception {
        ...
        if((tp = broadcastState.get(key)) != null
            ...
            com.alibaba.fastjson.JSONObject dataJsonObj = jsonObj.getJSONObject("data");
            ...
            out.collect(org.apache.flink.api.java.tuple.Tuple2.of(dataJsonObj,tp));
        }
    }
    @Override
    public void processBroadcastElement(TableProcessDwd tp, BroadcastProcessFunction<com.alibaba.fastjson.JSONObject, TableProcessDwd, org.apache.flink.api.java.tuple.Tuple2<com.alibaba.fastjson.JSONObject, TableProcessDwd>>.Context ctx, Collector<org.apache.flink.api.java.tuple.Tuple2<com.alibaba.fastjson.JSONObject, TableProcessDwd>> out) throws Exception {
        //获取对配置表进行的操作的类型
        String op = tp.getOp();
        //获取广播状态
    ...
    private static void deleteNotNeedColumns(com.alibaba.fastjson.JSONObject dataJsonObj, String sinkColumns) {
