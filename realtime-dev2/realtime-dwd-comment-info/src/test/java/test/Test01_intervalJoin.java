...
/**
 * @Package com.lzr.realtime.dwd.test.Test01_intervalJoin
 * @Author lv.zirao
 * @Date 2025/4/15 10:24
 * @description:
        ...
        empDS.keyBy(Emp::getDeptno)
                ...
                .process(
                        new ProcessJoinFunction<Emp, Dept, Tuple2<Emp,Dept>>() {
                            @Override
                            public void processElement(Emp emp, Dept dept, ProcessJoinFunction<Emp, Dept, Tuple2<Emp, Dept>>.Context ctx, Collector<Tuple2<Emp, Dept>> collector) throws Exception {
