...
//        tableEnv.executeSql("select * from  order_info limit 5").print();
        //TODO 过滤出明细活动数据
...
//  tableEnv.executeSql("select * from  order_detail_activity limit 5").print();
        //TODO 过滤出明细优惠券数据
...
//         tableEnv.executeSql("select * from  order_detail_coupon limit 5").print();
//        //TODO 关联上述4张表
        ...
        tableEnv.createTemporaryView("onew", result);
        tableEnv.executeSql("select * from  onew limit 5").print();
//
