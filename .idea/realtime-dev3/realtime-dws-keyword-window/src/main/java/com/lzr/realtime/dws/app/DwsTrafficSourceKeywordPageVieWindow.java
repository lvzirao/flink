...
import com.lzr.realtime.dws.function.KeywordUDTF;
import com.lzr.realtime.util.SQLUtil;
import org.apache.flink.table.api.Table;
import org.apache.flink.table.api.bridge.java.StreamTableEnvironment;

/**
 * @Package com.lzr.realtime.dws.app.DwsTrafficSourceKeywordPageVieWindow
 * @Author lv.zirao
 * @Date 2025/4/17 21:44
 * @description:
 */
public class DwsTrafficSourceKeywordPageVieWindow extends BaseSQLApp {
    public static void main(String[] args) {
        new DwsTrafficSourceKeywordPageVieWindow().start(
                10021,
                4,
...
//        // TODO 调用自定函数完成分词 并和原表的其它字段进行join
...
//                "     date_format(window_start, 'yyyy-MM-dd HH:mm:ss.SSS') stt,\n" +
//                "     date_format(window_end, 'yyyy-MM-dd HH:mm:ss.SSS') edt,\n" +
